...
class AuthorityEmergencyHistory extends StatefulWidget {
  const AuthorityEmergencyHistory({super.key});

  @override
  _AuthorityEmergencyHistoryState createState() => _AuthorityEmergencyHistoryState();
}

class _AuthorityEmergencyHistoryState extends State<AuthorityEmergencyHistory > {
  String? tappedCategory;
  String selectedCategory = "BARANGAY PERSONNEL";
  final List<String> categories = ["MEDICAL","BARANGAY PERSONNEL"];
              ...
              (context, innerBoxIsScrolled) => [
                SliverAppBar(
                  ...
                  title: Row(
                    ...
                    children: [
                      Image.asset(
                        'assets/icon_rphistory_white.png',
                        height: 16,
                      ),
