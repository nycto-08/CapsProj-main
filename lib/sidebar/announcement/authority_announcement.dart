...
class AuthorityAnnouncement extends StatefulWidget {
  const AuthorityAnnouncement({super.key});

  @override
  _AuthorityAnnouncementState createState() => _AuthorityAnnouncementState();
}

class _AuthorityAnnouncementState extends State<AuthorityAnnouncement> {
                                    ...
                                    subtitle: Row(
                                        ...
                                        children: [
                                            ...
                                            Row(
                                                ...
                                                return audienceList.where((aud) => aud == "Authority") .map<Widget>((aud) => Padding(
                                                padding: const EdgeInsets.only(right: 4.0),
                                                child: Chip(
                                                    label: Text("Authority", style: const TextStyle(fontSize: 13, color: Colors.white)),
