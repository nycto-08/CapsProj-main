import 'package:bantay_alertdraft/sidebar/barangay_sidebar/create_emergency_hotline.dart';
import 'package:bantay_alertdraft/sidebar/my_profile/authority_my_profile.dart';
import 'package:bantay_alertdraft/sidebar/barangay_sidebar/authority_approval_list.dart';
import 'package:bantay_alertdraft/sidebar/barangay_sidebar/barangay_respond_history.dart';
import 'package:bantay_alertdraft/sidebar/barangay_sidebar/create_announcement.dart';
import 'package:bantay_alertdraft/sidebar/barangay_sidebar/resident_approval_list.dart';
import 'package:bantay_alertdraft/sidebar/setting_sidebar/barangay_setting.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';
import 'package:bantay_alertdraft/variable/authority_variable.dart';

class BarangaySidebar extends StatelessWidget {
  const BarangaySidebar({super.key});
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage: AssetImage(
                        authorityData.profileImagePath.isNotEmpty
  ...
  // Function for menu items using custom image icons
  Widget _buildMenuItemWithImage2(
    String iconPath,
    String title,
    String imagePath,
    BuildContext context,
