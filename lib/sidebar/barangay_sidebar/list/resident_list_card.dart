...
class ResidentListCard extends StatefulWidget {
  const ResidentListCard({super.key});

  @override
  _ResidentListCard createState() => _ResidentListCard();
}

class _ResidentListCard extends State<ResidentListCard> {
