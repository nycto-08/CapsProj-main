...
class AuthorityListCard extends StatefulWidget {
  const AuthorityListCard({super.key});

  @override
  _AuthorityListCard createState() => _AuthorityListCard();
}

class _AuthorityListCard extends State<AuthorityListCard> {
