...
class AuthorityMyProfile extends StatefulWidget {
  const AuthorityMyProfile({super.key});

  @override
  _AuthorityMyProfile createState() => _AuthorityMyProfile();
}

class _AuthorityMyProfile extends State<AuthorityMyProfile> {
  @override
                ...
                builder: (context, authorityVariable, child) {
                  return Column(
                    children: [
                      ...
                      Text(
                        authoVar.getEmployeeNumber.isEmpty
                            ? "LOADING..."
                            : authoVar.getEmployeeNumber,
                          style: TextStyle(
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Flexible(
                                        flex: 1,
                                        child: buildReadTextField(
                                          controller: TextEditingController(text: authoVar.getBarangayEmergency),
