import 'package:bantay_alertdraft/login_pages/authority_forgotpassword/authority_forgot_verification_code.dart';
...
class AuthorityForgotEmail extends StatefulWidget {
  const AuthorityForgotEmail({super.key});

  @override
  _AuthorityForgotEmailPage createState() => _AuthorityForgotEmailPage();
}

class _AuthorityForgotEmailPage extends State<AuthorityForgotEmail> {
  ...
  void _next() async {
    ...
    try {
      ...
      Navigator.pushReplacement(
        ...
        MaterialPageRoute(
          builder:
              (_) => AuthorityForgotVerificationCode(
                        ...
                        builder: (context, authorityVariable, child) {
                          return Column(
                            ...
                            children: [
                              buildTextField(
                                controller:
                                    authorityVariable.newEmailController,
                                focusNode: authorityVariable.newEmailFocusNode,
                                  ...
                                  if (value == null ||
                                    ...
                                    WidgetsBinding.instance
                                        .addPostFrameCallback((_) {
                                          authorityVariable.emailController
                                              .clear();
                                        });
