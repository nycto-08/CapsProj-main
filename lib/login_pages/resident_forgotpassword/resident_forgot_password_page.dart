...
class ResidentForgotPasswordPage extends StatefulWidget {
  final String email;
  ResidentForgotPasswordPage({required this.email});

  @override
  _ResidentForgotPasswordPage createState() => _ResidentForgotPasswordPage();
}

class _ResidentForgotPasswordPage extends State<ResidentForgotPasswordPage> {
    ...
    try {
      ...
      if (mounted) {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (_) => ResidentLoginPage()),
        );
      }
    } catch (e) {
                        ...
                        builder: (context, residentVariable, child) {
                          return Column(
                            ...
                            children: [
                              buildPasswordField(
                                controller:
                                    residentVariable.newPasswordController,
                                focusNode:
                                    residentVariable.newPasswordFocusNode,
                              ...
                              buildPasswordField(
                                controller:
                                    residentVariable.confirmPassController,
                                focusNode:
                                    residentVariable.confirmPasswordFocusNode,
