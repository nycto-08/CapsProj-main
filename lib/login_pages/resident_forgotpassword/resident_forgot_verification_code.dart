...
class ResidentForgotVerificationCode extends StatefulWidget {
  final Map<String, dynamic> residentData;
  final String email;

  const ResidentForgotVerificationCode({
    super.key,
  ...
  @override
  _ResidentForgotVerificationCode createState() =>
      _ResidentForgotVerificationCode();
}

class _ResidentForgotVerificationCode
    extends State<ResidentForgotVerificationCode> {
      ...
      if (doc.exists && storedCode == enteredCode) {
        ...
        if (residentQuery.docs.isNotEmpty) {
          ...
          Navigator.pushReplacement(
            ...
            MaterialPageRoute(
              builder:
                  (context) => ResidentForgotPasswordPage(email: widget.email),
            ),
          );
        }
      } else {
          ...
          leading: IconButton(
            ...
            onPressed: () {
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => const ResidentForgotEmail(),
                ),
              );
            },
          ),
